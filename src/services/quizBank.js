/**
 * StudyMate - Comprehensive Quiz Bank with 30+ Questions Per Subject
 * Subjects:
 * 1. Data Structures & Algorithms (32 questions)
 * 2. Operating Systems (32 questions)
 * 3. Database Management Systems (DBMS) (32 questions)
 * 4. Computer Networks (32 questions)
 * 5. Software Engineering (32 questions)
 * 6. Python Programming (32 questions)
 * 7. Mathematics for CS (32 questions)
 */
...
export const EXTENDED_QUIZZES = [
  ...
  // -------------------------------------------------------------
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Directed cycles", "Disconnected components", "Negative weight edges", "Dense graphs"],
        correct: 2,
      ...
      },
      {
        ...
        options: ["O(log N)", "O(N)", "O(sqrt(N))", "O(N log N)"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["At the root", "At an internal node", "At one of the leaf nodes", "It cannot be determined"],
        correct: 2,
      ...
      },
      {
        ...
        options: ["Greedy algorithm", "Dynamic Programming", "Divide and Conquer", "Radix Sort"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Disjoint Set Union (DSU / Union-Find)", "Hash Map", "Suffix Tree", "Fenwick Tree"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["T(N) = 2T(N/2) + O(N)", "T(N) = T(N-1) + O(N)", "T(N) = 2T(N/2) + O(1)", "T(N) = T(N/2) + O(1)"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["floor(log2(N)) + 1", "N / 2", "N", "2 * log2(N)"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Merge Sort", "Heap Sort", "Counting Sort", "Bucket Sort"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Pre-order only", "Post-order only", "Either Pre-order or Post-order", "Level-order only"],
        correct: 2,
      ...
      },
      {
        ...
        options: ["Red-Black Tree", "B+ Tree", "Splay Tree", "Segment Tree"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["u appears after v", "u appears before v", "u and v must have equal in-degrees", "v must have zero out-degree"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Less memory used", "Bidirectional traversal and O(1) node deletion with pointer", "Random access O(1)", "Cache locality"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Fenwick Tree (Binary Indexed Tree)", "Linked List", "Queue", "Binary Search Tree"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["O(V * E)", "O(V + E)", "O(E log V)", "O(V^2)"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Shortest Path in Weighted Graph", "Traveling Salesperson Decision Problem", "Minimum Spanning Tree", "Connected Components"],
        correct: 1,
  ...
  // -------------------------------------------------------------
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Starvation", "Thrashing", "Fragmentation", "Context Flooding"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Instruction opcodes", "Virtual to physical page frame translations", "Disk sector addresses", "Interrupt vectors"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Round Robin", "Shortest Job First (Non-preemptive)", "Priority Scheduling", "Multilevel Feedback Queue"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["fork()", "exec()", "spawn()", "clone_thread()"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Independent memory spaces", "Faster context switching and shared memory within the process", "Immunity from race conditions", "No OS scheduling needed"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Deadlock Detection", "Deadlock Avoidance", "Memory Allocation", "CPU Quantum Timing"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Sets a bit to 0 and returns original value", "Sets a memory word to 1 and returns previous value atomically", "Flushes CPU cache", "Swaps register with memory asynchronously"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["FCFS", "Round Robin", "Shortest Remaining Time First", "Priority Non-preemptive"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Allocated memory block is slightly larger than requested memory", "Total free memory is enough but not contiguous", "Page table is full", "Swap partition runs out of space"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Compaction and Paging", "Increasing page size", "Disabling virtual memory", "Overlays"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Orphan Process", "Zombie Process", "Daemon Process", "Foreground Process"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["kernel (pid 0)", "init / systemd (pid 1)", "cron", "bash"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["The actual file content", "Data structure storing file metadata, permissions, and block pointers", "Directory path string", "Master Boot Record sector"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Pipes", "Message Queues", "Shared Memory", "All of the above"],
        correct: 3,
      ...
      },
      {
        ...
        options: ["Polling hardware in infinite loop", "Notifying CPU asynchronously that I/O operation has completed", "Translating virtual addresses", "Formatting disk blocks"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Parent and child share read-only pages until one modifies a page", "All memory is copied immediately during fork", "Files are backed up on every write", "Cache is written directly to disk"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["System freezes completely", "Outcome depends on the non-deterministic interleaving or timing of execution", "One process takes all CPU cycles", "Two threads deadlocking on one mutex"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["LRU", "FIFO", "Optimal (OPT / Belady's Min)", "Clock Policy"],
        correct: 2,
      ...
      },
      {
        ...
        options: ["Indicates page has syntax errors", "Indicates page has been modified in memory and must be written back to disk on eviction", "Indicates page is corrupted", "Tracks TLB hits"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Placing I/O jobs in a buffer/disk queue so device processes them at its own speed", "CPU overclocking technique", "Direct memory access bypass", "Network packet routing"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Faster access than single level", "Reduces physical memory used to store page tables for sparse virtual address spaces", "Eliminates TLB misses", "Simplifies hardware logic"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Software-generated interrupt caused by error or system call request", "Hardware circuit failure", "Infinite while loop", "Deadlock condition"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["FCFS", "SSTF", "SCAN (Elevator Algorithm)", "C-LOOK"],
        correct: 2,
      ...
      },
      {
        ...
        options: ["Monolithic runs all OS services in kernel space; microkernel moves non-essential services to user space", "Monolithic is slower", "Microkernel has no memory management", "Monolithic only supports single-core"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["System call returns immediately, process checks status or receives callback later", "Thread halts until bytes are read", "Process enters sleep state", "CPU disables interrupts"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Enable processes to address larger memory than physical RAM and provide isolation/protection", "Increase physical disk rotation speed", "Accelerate CPU clock rate", "Eliminate L1 cache"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Low priority task blocks high priority task via lock; resolved with Priority Inheritance", "High priority process starves; resolved with aging", "Threads execute in reverse order; resolved with LIFO", "Deadlock between 3 processes"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Contiguous Allocation", "Linked Allocation", "Indexed Allocation", "Tape Storage Allocation"],
        correct: 2,
  ...
  // -------------------------------------------------------------
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Exclusive Lock (X)", "Shared Lock (S)", "Intent Exclusive Lock (IX)", "Schema Lock"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Leaf nodes are linked in a chain, making range scans fast", "Internal nodes store data pointers", "Requires zero rebalancing", "Uses less disk storage"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Y is a candidate key", "X is a superkey", "X is a subset of Y", "Y is a prime attribute"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Natural Join", "Cartesian Product", "Union", "All of the above"],
        correct: 3,
      ...
      },
      {
        ...
        options: ["An index where physical order of rows on disk matches index order", "An index on multiple columns", "An index stored in separate file", "A non-unique index"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Log records must be flushed to disk before corresponding data pages are written", "Data pages flushed before log", "No logging needed if in RAM", "Indexes written first"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["1", "Empty set (no rows)", "NULL", "Error"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Maximize query join performance", "Minimize data redundancy and eliminate insert/update/delete anomalies", "Increase table size", "Create automatic backups"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["A physical copy of table on disk", "A virtual table based on the result-set of an SQL statement", "A stored procedure", "A database trigger"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["ARIES", "Banker's", "Dijkstra", "Graham Scan"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Prevents deletion of parent row", "Automatically deletes dependent child rows when parent row is deleted", "Sets child foreign keys to NULL", "Throws runtime exception"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["An index with an entry for every search key value in data file", "An index only for some blocks", "An index without pointers", "An uncompressed index"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Its precedence (serialization) graph is acyclic", "It uses only exclusive locks", "All transactions execute sequentially", "No rollback occurs"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Executes once for entire outer query", "Executes repeatedly for each candidate row evaluated by outer query", "Runs in background thread", "Cannot reference outer table"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Eliminating partial dependencies", "Relation is in BCNF and has no multi-valued dependencies (MVD)", "Eliminating transitive dependencies", "Splitting numeric keys"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Reduces recovery time by flushing dirty pages and writing a checkpoint record to log", "Locks the database from writes", "Defragments secondary storage", "Backs up SQL scripts"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["TRUNCATE is DDL, faster, and deallocates pages without row-by-row logging", "DELETE is faster than TRUNCATE", "TRUNCATE can use WHERE clause", "There is no difference"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Consistency, Availability, and Partition Tolerance cannot all be guaranteed simultaneously", "Compute, Architecture, Performance", "Concurrency, Atomicity, Persistence", "Control, Authorization, Privacy"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Weak Entity", "Identifying Relationship", "Composite Attribute", "Derived Attribute"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["GROUP BY", "PARTITION BY", "ORDER BY", "SPLIT BY"],
        correct: 1,
    ...
    questions: [
      {
        ...
        options: ["SYN -> SYN-ACK -> ACK", "ACK -> SYN -> SYN-ACK", "FIN -> ACK -> FIN-ACK", "SYN -> ACK -> DATA"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Checksum", "TTL (Time to Live) field in IP header", "Sequence Number", "Subnet Mask"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Dijkstra's Algorithm", "Floyd-Warshall", "Bellman-Ford", "Kruskal's Algorithm"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Slow Start (exponential growth)", "Congestion Avoidance (linear growth)", "Fast Recovery", "Random Early Detection"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["ping and traceroute", "telnet and ssh", "curl and wget", "ftp and scp"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Retransmit immediately", "Wait a random backoff time calculated by Binary Exponential Backoff", "Switch to token ring", "Drop connection"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["OSPF", "BGP (Border Gateway Protocol)", "RIP", "EIGRP"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Translates private non-routable IP addresses into public routable IP addresses", "Compresses HTTP headers", "Encrypts Wi-Fi passwords", "Routes packets across VLANs"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Sets Window Size = 0 in ACK segment", "Sends RST flag", "Closes socket connection", "Drops incoming packets silently"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["DNS Spoofing / Cache Poisoning", "SYN Flood", "Man-in-the-Middle", "Cross-Site Scripting"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Bit Stuffing", "Byte Stuffing (Character Stuffing)", "Manchester Encoding", "CRC Check"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["2 * B * log2(V)", "B * log2(1 + S/N)", "B * V^2", "V * log2(B)"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Signal-to-Noise Ratio (SNR)", "Subnet mask size", "Cable color", "Clock frequency"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Allows receiver to inform sender about all received disjoint segments, avoiding retransmission of already received packets", "Encrypts TCP payloads", "Combines ACK with HTTP POST", "Bypasses flow control"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Prevent switching loops and broadcast storms", "Encrypt ethernet frames", "Route traffic between subnets", "Allocate IP addresses"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Binary framing, multiplexing multiple streams over single TCP connection, and header compression (HPACK)", "Runs over UDP", "Removes SSL requirement", "Requires no web server"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["TCP", "QUIC (over UDP)", "SCTP", "RSVP"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Asymmetric Key Cryptography (RSA or Diffie-Hellman)", "Cleartext HTTP header", "Symmetric AES without keys", "Hardware jumper"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Logically segment single physical switch network into multiple isolated broadcast domains", "Increase internet speed", "Replace DNS servers", "Translate IPv4 to IPv6"],
        correct: 0,
    ...
    questions: [
      {
        ...
        options: ["Single Responsibility Principle", "System Integration Principle", "Scalability Principle", "Security Principle"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["1 to 4 weeks", "6 months", "1 year", "1 day"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Object-oriented Principle", "Open/Closed Principle", "Operational Principle", "Optimization Principle"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Unit Testing", "Regression Testing", "Smoke Testing", "Performance Testing"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Subtypes must be substitutable for their base types without altering program correctness", "Classes must only inherit once", "Base classes cannot have abstract methods", "All interfaces must be sealed"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Decorator Pattern", "Singleton Pattern", "Builder Pattern", "Prototype Pattern"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Moves or reapplies commits on top of another base tip for linear commit history", "Deletes repository", "Creates backup branch", "Pushes code to GitHub"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Assign tasks to engineers", "Facilitate Scrum ceremonies and remove team impediments", "Write software code", "Act as product CEO"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Single codebase and shared deployment", "Decoupled services independently deployable and communicating over lightweight APIs", "Zero network latency", "Single database for all tables"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Continuous Integration / Continuous Delivery (or Deployment)", "Computer Interface / Data Control", "Code Inspection / Code Debugging", "Central Index / Cloud Deployment"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Builder Pattern", "State Pattern", "Flyweight Pattern", "Visitor Pattern"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Number of linearly independent execution paths through code", "Number of lines of code", "Number of variables declared", "Size of compiled binary"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Core / Domain Layer (innermost)", "UI / Web Layer", "Database Framework Layer", "External Devices"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Write tests after production deployment", "Follow Red-Green-Refactor cycle: write failing test, write minimal code to pass, refactor", "Only test frontend components", "Skip integration tests"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Adapter Pattern", "Proxy Pattern", "Composite Pattern", "Command Pattern"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Poor code quality", "Good modularity: modules focus on single purpose and have minimal interdependence", "Code is too small", "Memory leaks"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Product version with core features sufficient to validate hypothesis with early adopters", "Cheapest possible code", "Bug-ridden release", "Final production system"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Command Pattern", "Chain of Responsibility", "Mediator", "Memento"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Clients should not be forced to depend on methods they do not use", "Never create interfaces", "Interfaces must have at least 10 methods", "All methods must be public static"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["High-level modules should not depend on low-level modules; both should depend on abstractions", "Dependencies must be reversed alphabetically", "Modules should create their own concrete dependencies", "Use global variables"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["MVC Pattern", "Blackboard Pattern", "Peer-to-Peer", "Pipe and Filter"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Syntax errors that prevent compilation", "Surface indicators in code that usually correspond to deeper design problems", "Missing semicolons", "Deprecated libraries"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Simulates behavior of external dependencies (e.g. API/Database) in controlled manner", "Taunts other developers", "Disables test runners", "Executes integration tests"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Facade Pattern", "Flyweight Pattern", "Proxy Pattern", "Bridge Pattern"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Monetary cost of server hosting", "Future cost of rework caused by choosing an easy, fast solution now instead of better approach", "Unpaid software licenses", "Salary of contractors"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Constraint on number of active work items in a stage to prevent bottlenecks", "Minimum lines of code", "Team size limit", "Maximum bug count"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Boundary Value Analysis (BVA)", "Stress Testing", "Usability Testing", "Alpha Testing"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Breaking changes . New backward-compatible features . Backward-compatible bug fixes", "Year . Month . Day", "Files . Lines . Characters", "Random build numbers"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Strategy Pattern", "Template Method", "State Pattern", "Chain of Responsibility"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Intentionally introducing small errors (mutants) into source code to check if test suite catches them", "Testing DNA sequencing apps", "Randomizing UI clicks", "Compiling on different platforms"],
        correct: 0,
    ...
    questions: [
      {
        ...
        options: ["A mutex that allows only one thread to execute Python bytecode at a time", "A compiler optimization", "A security firewall", "A package manager lock"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Preserves original function name, docstring, and metadata", "Makes function run faster", "Converts function to async", "Allows multi-threading"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Marks directory as a regular Python package for module imports", "Executes unit tests", "Stores compiled byte code", "Configures virtual environments"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Reference counting combined with a generational cyclic garbage collector", "Manual malloc and free", "Stack allocation only", "No garbage collection"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["'==' checks equality of values; 'is' checks identity of memory addresses", "'==' checks memory; 'is' checks value", "They are completely identical", "'is' only works for strings"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Prevents creation of dynamic __dict__, reducing instance memory footprint", "Limits number of class instances", "Makes methods private", "Disables inheritance"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["<class 'function'>", "<class 'lambda'>", "<class 'anonymous'>", "<class 'method'>"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["lst is created once at function definition time and shared across all subsequent invocations", "A fresh list is created on every call", "Python throws SyntaxError", "lst is garbage collected after return"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Compresses files to .zip archive", "Iterates over multiple iterables simultaneously, pairing corresponding elements in tuples", "Sorts two lists together", "Combines dictionaries"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["StopIteration", "GeneratorExit", "IndexError", "EOFError"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["C3 Superconcurrency Linearization Algorithm", "Depth-First Left-to-Right exclusively", "Random selection", "Alphabetical order"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["2 and 2.5", "2.5 and 2", "2 and 2", "2.5 and 2.5"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["collections", "itertools", "functools", "structures"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Deepcopy recursively copies all nested objects; copy creates shallow reference clones", "Deepcopy is faster", "Copy cannot clone lists", "Deepcopy converts to string"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["async def", "yield from", "coroutine def", "task"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["A null statement that does nothing, used as placeholder where code is syntactically required", "Exits current loop", "Skips exception handling", "Passes return value to parent"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Delegates method calls to parent class dynamically via MRO", "Makes class immutable", "Initializes global variables", "Creates singleton"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["enumerate()", "iterator()", "counter()", "indexof()"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["KeyError is raised", "The key is automatically created with default value 0", "Returns None", "Application crashes"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["{1, 2, 3}", "[1, 2, 3]", "{1: 2, 2: 1}", "{1, 2, 2, 3, 1}"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["__str__ is user-friendly; __repr__ is unambiguous and developer-oriented for debugging", "__str__ is for numbers; __repr__ is for text", "They must return identical strings", "__str__ cannot be overridden"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["collections.deque", "list", "array", "set"],
        correct: 0,
  ...
  // -------------------------------------------------------------
  // 7. MATHEMATICS FOR COMPUTER SCIENCE (32 Questions)
  // -------------------------------------------------------------
  {
    id: "quiz_math",
    subject: "Mathematics",
    ...
    questions: [
      {
        ...
        options: ["No students passed the exam", "At least one student did not pass the exam", "All students failed the exam", "Only some students passed the exam"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["Reflexive, Symmetric, and Transitive", "Reflexive, Antisymmetric, and Transitive", "Symmetric and Irreflexive", "Transitive only"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["V - E + F = 2", "V + E + F = 2", "V - E - F = 0", "V + E = F + 1"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Number of edges (E)", "Twice the number of edges (2E)", "E^2", "Number of vertices (V)"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["All are 1", "All are 0", "1 to N", "N"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Complete Graph (K_n)", "Bipartite Graph", "Tree", "Planar Graph"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Partial Order (Poset)", "Equivalence Relation", "Function", "Total Lattice"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["2", "1", "3", "Depends on number of vertices"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Sum of elements on the main diagonal", "Product of main diagonal", "Determinant", "Rank of matrix"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["N * (N + 1) / 2", "N^2", "N * (N - 1) / 2", "(N + 1)^2 / 2"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["A^T * A = I (transpose equals inverse)", "det(A) = 0", "A = A^T", "Trace(A) = 0"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Maximum number of linearly independent rows or columns", "Number of rows plus columns", "The largest element", "The determinant squared"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Every vertex must have even degree", "Every vertex must have odd degree", "At most two vertices have odd degree", "All vertices have degree >= 3"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Proof by Contradiction (Reductio ad absurdum)", "Direct Proof", "Mathematical Induction", "Proof by Construction"],
        correct: 0,
