  ...
  quizzes: [
    {
      id: "quiz_dsa",
      subject: "Data Structures & Algorithms",
      title: "DSA Core Concepts & Complexities",
      description: "Test your knowledge of Trees, Heaps, Graph algorithms, and asymptotic runtime complexities.",
      questions: [
        {
          id: "q1",
          question: "What is the worst-case time complexity of QuickSort when a naive pivot selection is used?",
          options: ["O(N log N)", "O(N^2)", "O(log N)", "O(N)"],
          correct: 1,
          explanation: "In the worst case (e.g., already sorted array with first element as pivot), QuickSort partitions into 1 and N-1 elements, yielding O(N^2) complexity."
        },
        {
          id: "q2",
          ...
          correct: 1,
          explanation: "BFS explores nodes level by level using a FIFO Queue to maintain discovery order."
        },
        {
          id: "q3",
        ...
        {
          id: "q4",
          question: "Dijkstra's shortest path algorithm fails or gives incorrect results in the presence of which of the following?",
          options: ["Directed cycles", "Disconnected components", "Negative weight edges", "Dense graphs"],
          correct: 2,
          explanation: "Dijkstra relies on greedy assumption that adding an edge only increases path cost. Negative weights violate this, requiring Bellman-Ford."
        },
        {
          id: "q5",
          ...
          correct: 0,
          explanation: "A hash table with a good hash function and low load factor achieves O(1) expected lookup time."
        }
      ]
    },
    {
      ...
      description: "Test your mastery of processes, threads, semaphores, scheduling, and virtual memory.",
      questions: [
        {
          id: "q_os1",
          ...
          correct: 2,
          explanation: "The condition is NO Preemption (resources cannot be forcibly taken from a process). Allowing preemption prevents deadlocks."
        },
        {
          id: "q_os2",
          ...
          correct: 1,
          explanation: "Thrashing happens when the working sets of active processes exceed available physical memory."
        },
        {
          id: "q_os3",
          question: "What does the TLB (Translation Lookaside Buffer) cache in modern processors?",
          options: ["Instruction opcodes", "Virtual to Physical Page translations", "Disk sector addresses", "Cache coherency flags"],
          correct: 1,
          explanation: "The TLB is a high-speed hardware cache storing recent page table entries (virtual page number to physical frame number)."
        },
        {
          id: "q_os4",
          question: "Which CPU scheduling algorithm is non-preemptive and guarantees maximum throughput for batch systems?",
          options: ["Round Robin", "Shortest Job First (Non-preemptive)", "Priority Scheduling", "Multilevel Feedback Queue"],
          correct: 1,
          explanation: "Shortest Job First (SJF) is mathematically optimal for minimizing average waiting time in batch processing."
        }
      ]
    },
    {
      ...
      description: "Test relational theory, normal forms, transaction ACID properties, and concurrency control.",
      questions: [
        {
          id: "q_db1",
          ...
          correct: 2,
          explanation: "3NF requires the relation to be in 2NF and that no non-prime attribute is transitively dependent on candidate keys."
        },
        {
          id: "q_db2",
          question: "The 'I' in the ACID properties of database transactions stands for what?",
        ...
        },
        {
          ...
          correct: 1,
          explanation: "HAVING filters groups after aggregation, whereas WHERE filters individual rows prior to grouping."
        }
      ]
    }
  ],
