...
export default function ProfilePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    major: profile.major || profile.course || 'B.Tech Computer Science & Engineering',
    university: profile.university || profile.college || 'Institute of Technology & Engineering',
    bio: profile.bio || 'Passionate CS undergrad specializing in Distributed Systems, Algorithms, and Full-Stack Engineering.',
